  ...
  \begin{standaloneframe}
    ...
    \begin{tikzpicture}
      \node[use as bounding box,anchor=south west,inner sep=0] (image) at (0,0) 
        {\includegraphics[width=\textwidth,height=\textheight]{/home/mrajner/src/grat/doc/figures/podklad}};
      \node<3>[use as bounding box,anchor=south west,inner sep=0] (image) at (0,0) 
        {\includegraphics[width=\textwidth,height=\textheight]{/home/mrajner/src/grat/doc/figures/podklad2}};

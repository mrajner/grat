...
########################################################################
Program started: 2014-07-03 10:09:54 (+02h UTC)
#-----------------------------------------------------------------------
Command invoked:
value_check -F ../data/pres.sfc.2012.nc @SP : pres, ../data/air.sig995.2
012.nc @T: air -S jozefoslaw : 52.0 : 21.0 : 110, tmp : -33.0 : 1.0 : -1
                   10, -D 20120101 : m : 24 @H -o t1.dat0.r -V t1.dat1.r
#-----------------------------------------------------------------------
Command parsing:
  ...
  -D { -D20120101:m:24@H }
    20120101:m:24@H
      ...
      dates total: 366
  -o { -ot1.dat0.r }
    output file was set: t1.dat0.r
  -V { -Vt1.dat1.r }
    verbose mode
    the log file was set t1.dat1.r
#-----------------------------------------------------------------------
    Processing: 2 site(s)
...
#-----------------------------------------------------------------------
Execution time:   0.1s (proc time:   0.1 |% 95.8)
#-----------------------------------------------------------------------

...
mod_3d.o : mod_3d.f90 
mod_admit.o : mod_admit.f90 mod_printing.o mod_site.o mod_atmosphere.o mod_data.o mod_cmdline.o 
mod_aggf.o : mod_aggf.f90 mod_printing.o mod_normalization.o mod_atmosphere.o 
mod_atmosphere.o : mod_atmosphere.f90 mod_printing.o 
mod_cmdline.o : mod_cmdline.f90 
mod_data.o : mod_data.f90 mod_atmosphere.o mod_polygon.o mod_printing.o mod_cmdline.o 
mod_date.o : mod_date.f90 mod_data.o mod_cmdline.o mod_printing.o 
mod_green.o : mod_green.f90 mod_3d.o mod_atmosphere.o mod_polygon.o mod_data.o mod_site.o mod_aggf.o mod_normalization.o mod_printing.o mod_cmdline.o 
...
value_check.o : value_check.f90 mod_atmosphere.o mod_polygon.o mod_site.o mod_date.o mod_data.o mod_parser.o mod_cmdline.o 

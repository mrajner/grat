...
subroutine print_version (program_calling)
  ...
  if (program_calling.eq."grat" ) then
    write(log%unit,form_inheader ) , 'grat v. 1.0'
    write(log%unit,form_inheader ) , 'Last modification: 20120910'
  elseif (program_calling.eq."polygon_check") then
    write(log%unit,form_inheader ) , 'polygon_check v. 1.0'
    write(log%unit,form_inheader ) , 'Last modification: 20120910'
    write(log%unit,form_inheader ) , ''
    write(log%unit,form_inheader ) , 'Check if given point (given with -S)'
    write(log%unit,form_inheader ) , 'is included or excluded usig &
      specific polygon file'
  elseif (program_calling.eq."value_check") then
    write(log%unit,form_inheader ) , 'value_check v. 1.0'
    write(log%unit,form_inheader ) , 'Last modification: 20120910'
    write(log%unit,form_inheader ) , ''
    write(log%unit,form_inheader ) , 'Check data value for given point (given with -S)'
  endif
  write(log%unit,form_inheader ) , ''

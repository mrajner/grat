...
value_check -F ../data/test_data.nc @SP : sp, ../data/test_data.nc @T: t
 -S r, equator : 0 : 0 : 0, south pole : -90 : 0 : 0, north_pole : 90 : 
0 : 0, out : 0 : 1361 : 0, out : -100 : -1361 : 0 out : 100 : 161 : 0 -D
 2012010124@~ , 2012010122@~ , 2012010144@~ , 20120311@~ -o t1.dat.out3.
                                                      s -V t1.dat.log3.s
#-----------------------------------------------------------------------
Command parsing:
  ...
  -D { -D2012010124@~,2012010122@~,2012010144@~,20120311@~ }
    ...
    20120311@~
      ...
      dates total: 4
  -o { -ot1.dat.out3.s }
    output file was set: t1.dat.out3.s
  -V { -Vt1.dat.log3.s }
    verbose mode
    the log file was set t1.dat.log3.s
#-----------------------------------------------------------------------
    Processing: 6 site(s)
...
#-----------------------------------------------------------------------
Execution time:   0.0s (proc time:   0.0 |%107.5)
#-----------------------------------------------------------------------

...
########################################################################
Program started: 2014-09-03 14:51:16 (+02h UTC)
#-----------------------------------------------------------------------
Command invoked:
...
0 : 0, out : 0 : 1361 : 0, out : -100 : -1361 : 0 out : 100 : 161 : 0 -D
 2012010124@~ , 2012010122@~ , 2012010144@~ , 20120311@~ -o t1.dat6.s -V
                                                               t1.dat7.s
#-----------------------------------------------------------------------
Command parsing:
  -F { test_data.nc@T:t }
  ...
  -D { -D2012010124@~,2012010122@~,2012010144@~,20120311@~ }
    ...
    20120311@~
      ...
      dates total: 4
  -o { -ot1.dat6.s }
    output file was set: t1.dat6.s
  -V { -Vt1.dat7.s }
    verbose mode
    the log file was set t1.dat7.s
#-----------------------------------------------------------------------
    Processing: 6 site(s)

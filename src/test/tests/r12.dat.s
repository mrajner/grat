...
#                           compiled on lidka_virt 2014-09-07 20:35:45 #
...
########################################################################
Program started: 2014-09-07 20:55:11 (+02h UTC)
#-----------------------------------------------------------------------
Command invoked:
grat -F ../data/test_data.nc @SP : sp -M2 -G@GN -Sj, r -I-1000@DD : 100@
                                           AS -V -L@p -o /dev/null -q -H
#-----------------------------------------------------------------------
Command parsing:
...
Execution time:   0.0s (proc time:   0.0 |% 94.6)
########################################################################
#                                                                 grat #
#                                                     v1.0-49-gdb28de8 #
########################################################################
...
Execution time:   0.0s (proc time:   0.0 |%101.7)

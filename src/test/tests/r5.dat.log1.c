...
#-----------------------------------------------------------------------
Command invoked:
value_check -! -F 0@VT -S g:20 -J 1000, 400 , 200 -o t5.dat.out1.c -V t5
                                                             .dat.log1.c
#-----------------------------------------------------------------------
Command parsing:
  -! { -! }
  ...
  -o { -ot5.dat.out1.c }
    output file was set: t5.dat.out1.c
  -V { -Vt5.dat.log1.c }
    verbose mode
    the log file was set t5.dat.log1.c
#-----------------------------------------------------------------------
    Processing: 180 site(s)
#-----------------------------------------------------------------------
Execution time:   0.0s (proc time:   0.0 |% 94.1)
#-----------------------------------------------------------------------

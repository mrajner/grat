...
########################################################################
Program started: 2019-02-08 14:18:17 (+01h UTC)
#-----------------------------------------------------------------------
Command invoked:
grat -! -H -F ../data/pres.sfc.2012.nc @SP :pres -M1,2 -G rajner @GN -S 
joze:52:21:100 -D2012:20@H : 3@H -I 0 @DE : 2@3D -o t6.dat.out5.r : free
                                                        -V t6.dat.log5.r
#-----------------------------------------------------------------------
Command parsing:
  -! { -! }
  ...
  -o { -ot6.dat.out5.r:free }
    output file was set: t6.dat.out5.r
  -V { -Vt6.dat.log5.r }
    verbose mode
    the log file was set t6.dat.log5.r
#-----------------------------------------------------------------------
    Processing: 1 site(s)

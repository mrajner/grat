...
########################################################################
Program started: 2019-02-13 12:48:46 (+01h UTC)
#-----------------------------------------------------------------------
Command invoked:
grat -! -H -F ../data/test_data.nc @SP : sp -M1,2 -G rajner @GN -S joze:
52:21:100 -D2012:20@H : 3@H -I 40 @DE : 2@3D -o /home/mrajner/src/grat/s
rc/test/tests/t6.dat.out9.s : free -V /home/mrajner/src/grat/src/test/te
                                                       sts/t6.dat.log9.s
#-----------------------------------------------------------------------
Command parsing:
  -! { -! }
  ...
  -o { -o/home/mrajner/src/grat/src/test/tests/t6.dat.out9.s:free }
    output file was set: t6.dat.out9.s
  -V { -V/home/mrajner/src/grat/src/test/tests/t6.dat.log9.s }
    verbose mode
    the log file was set t6.dat.log9.s
#-----------------------------------------------------------------------
    Processing: 1 site(s)
      Name lat [deg] lon [deg]     H [m]    Hp [m]    H* [m]   Hrsp[m]
      joze   52.0000   21.0000  100.0000        --        --        --
#-----------------------------------------------------------------------
Execution time:   0.0s (proc time:   0.6 |%  Inf)

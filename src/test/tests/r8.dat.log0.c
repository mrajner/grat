...
value_check -F 10 , 20:@gh2h , 30:@ scale=10 @ invscale=1000 , 40@name ,
 10:@gp2h , 30 @H -S a:10:20:100 , : 10 , c ,g :100 -H -o t8.dat.out0.c 
                                                        -V t8.dat.log0.c
#-----------------------------------------------------------------------
Command parsing:
  ...
  -H { -H }
      header
  -o { -ot8.dat.out0.c }
    output file was set: t8.dat.out0.c
  -V { -Vt8.dat.log0.c }
    verbose mode
    the log file was set t8.dat.log0.c
#-----------------------------------------------------------------------
    Processing: 9 site(s)
...
#-----------------------------------------------------------------------
Execution time:   0.0s (proc time:   0.0 |% 83.4)
#-----------------------------------------------------------------------

...
########################################################################
Program started: 2014-09-03 13:38:48 (+02h UTC)
#-----------------------------------------------------------------------
Command invoked:
value_check -F 10 , 20:@gh2h , 30:@ scale=10 @ invscale=1000 , 40@name ,
 10:@gp2h , 30 @H -S a:10:20:100 , : 10 , c ,g :100 -H -o t8.dat0.r -V t
                                                               8.dat10.r
#-----------------------------------------------------------------------
Command parsing:
  ...
  -H { -H }
      header
  -o { -ot8.dat0.r }
    output file was set: t8.dat0.r
  -V { -Vt8.dat10.r }
    verbose mode
    the log file was set t8.dat10.r
#-----------------------------------------------------------------------
    Processing: 9 site(s)
...
#-----------------------------------------------------------------------
Execution time:   0.0s (proc time:   0.0 |%117.6)
#-----------------------------------------------------------------------

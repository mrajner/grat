...
grat -M 1,2,3 -G rajner@GN , merriam @GE -F ../data/pres.sfc.2012.nc @SP
 :pres, ../data/hgt.2012.nc @GP :hgt, ../data/land.nc @LS :land, ../data
/hgt.sfc.nc @HP :hgt, ../data/hgt.sfc.nc @H :hgt, ../data/air.2012.nc @V
T :air , ../data/air.sig995.2012.nc @T :air, ../data/shum.2012.nc @VSH :
      shum, 101300 @ RSP, 0 @HRSP -U -D m:m:210@D -Sj -BI -H -I -10@DD :
#-----------------------------------------------------------------------
Command parsing:
  -M { -M1,2,3 }
